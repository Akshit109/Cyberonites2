...
const Team2025 = () => {
  ...
  return (
    <div className="team2025">

      {/* =========================================
          BACKGROUND GRID
      ========================================= */}

      <div className="team2025__grid" />
      ...
      <header className="team2025__header">

        <div className="team2025__eyebrow">
          <span className="team2025__line" />
          CYBERONITES / TEAM 2025
        </div>

        <h1 className="team2025__title">
          MEET THE
          <br />
          <span>CYBERONITES.</span>
        </h1>

        <p className="team2025__intro">
      ...
      <section className="team2025__section">

        <div className="team2025__section-header">

          <div>
            <p className="team2025__number">
              01 / GUIDANCE
            </p>
          ...
          <p className="team2025__section-description">
        ...
        <div className="team2025__gallery">

          {mentors.map((member, index) => (

            <motion.div
              key={`${member.name}-${index}`}
              className="team2025__gallery-item"
              initial={{
                opacity: 0,
                y: 35,
              }}
      ...
      <section className="team2025__end">

        <p>CYBERONITES / 2025</p>
