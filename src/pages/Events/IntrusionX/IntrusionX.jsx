...
import "./IntrusionX.css";

// -------------------- IMAGE ASSETS --------------------
import eventBannerImgFile from "../../../img/intrusionX/D1.webp";
              ...
              <div className="flex flex-wrap gap-2 font-orbitron text-xs uppercase font-bold">
                {[
                  ...
                  <button
                    ...
                    className={`px-4 py-2 border-2 border-white transition-all font-extrabold ${
                      activeChallengeCategory === tab.id
